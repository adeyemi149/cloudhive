	...
	<div name="support" className='w-full mt-24'>
		  <div className='w-full h-[700px] bg-gray-900/90 absolute'>
		   ...
		   <div className='max-w-[1240px] mx-auto text-white relative'>
				<div className='px-4 py-12' data-aos = "flip-up">
					<h1 className='pt-8 text-slate-300 uppercase text-center'>Support</h1>
			    ...
			    <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
				   <div className='bg-white rounded-xl shadow-2xl' data-aos = "slide-right">
					    <div className='p-8'>
				   ...
				   <div className='bg-white rounded-xl shadow-2xl' data-aos="slide-up">
						<div className='p-8'>
				   ...
				   <div className='bg-white rounded-xl shadow-2xl' data-aos='slide-left'>
						<div className='p-8'>
