...
const Hero = () => {
  return (
	  <div name="home" className='w-full h-screen bg-zinc-200 flex flex-col justify-between mt-20 sm:mt-11'>
		  <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
			  ...
			  <div className='absolute flex flex-col justify-center items-center py-8 md:min-w-[760px] bottom-[-25%] md:bottom-[-15%] 
			  mx-1 mt-6 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border 
			  border-slate-300 rounded-xl text-center shadow-xl'>
				  <p>Data Services</p>
				  <div className='flex md:justify-between items-start flex-wrap px-4'>
